...
# format: "package.name:module_name:overrides"
MICROG_APPS=(
    "com.google.android.gms:GmsCore:GmsCore"
    "com.google.android.gsf:GsfProxy:GsfProxy"
    "com.android.vending:FakeStore:Google Play Store"
)